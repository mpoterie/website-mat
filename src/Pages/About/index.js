    ...
    <div className="body-container container-short">
      ...
      <div className="paragraph-container">
        <p className="paragraph">
          ...
          an illustrious roster of artists, such as Yael Naim, Yamay and
          collaborating as a stage musician with Emel and David Donatien. His
          creative palette allows him to craft captivating compositions for
          singers, musicians and visual artists to crafting evocative
